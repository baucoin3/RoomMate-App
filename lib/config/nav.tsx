...
export const HOUSEHOLD_NAV: NavItem[] = [
  {
    ...
    label: 'Home',
    icon: HomeIcon,
    href: (id) => ROUTES.HOUSEHOLD(id),
  },
  {
    key: 'shopping',
    label: 'Shop',
    icon: ShopIcon,
    href: (id) => ROUTES.HOUSEHOLD_SHOPPING(id),
  },
  {
    key: 'recipes',
    label: 'Recipes',
    icon: RecipesIcon,
    href: (id) => ROUTES.HOUSEHOLD_RECIPES(id),
  },
  {
    key: 'finances',
    label: 'Bills',
    icon: FinancesIcon,
    href: (id) => ROUTES.HOUSEHOLD_FINANCES(id),
  },
  {
    key: 'receipts',
  ...
  {
    key: 'household',
    label: NAV.ITEMS.HOUSEHOLD,
    icon: HouseholdIcon,
    href: (id) => ROUTES.HOUSEHOLD_SETTINGS(id),
  },
]
