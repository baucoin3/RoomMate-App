...
export const FINANCES = {
  ...
  OVERVIEW: {
    ...
    RECURRING_SUBSECTION_TITLE: 'Recurring',
    RECURRING_BADGE: 'Recurring',
    RECURRING_MEMBER_PENDING: 'Pending',
    RECURRING_MEMBER_AWAITING: 'Awaiting',
    SETTLE_RECURRING: 'Settle',
    SETTLING_RECURRING: 'Settling…',
    CONFIRM_MONTH_SHORT: 'Log month',
    SETTLED_HISTORY_TITLE: 'Settled (Last 30 Days)',
    NO_SETTLED: 'No settled expenses in the last 30 days.',
    YOU_PAID_TO: (name: string) => `You paid ${name}`,
    PAID_YOU: (name: string) => `${name} paid you`,
    RECURRING_OWED_TO_YOU: (name: string, amount: string) => `${name} owes you $${amount}`,
    RECURRING_YOU_OWE: (name: string) => `You owe ${name}`,
...
export const HOUSEHOLD_DASHBOARD = {
  ...
  CALENDAR: {
    ...
    GROCERY_VISIT: (merchant: string) => `Shopped at ${merchant}`,
